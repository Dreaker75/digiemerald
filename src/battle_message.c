...
static const u8 sText_PkmnGainedEXP[] = _("Gained {B_BUFF3} EXP. Points!\p");
...
#if EVOLUTION_TYPE == POKEMON_EVOLUTION
const u8 gText_CongratsPkmnEvolved[] = _("Congratulations! Your {STR_VAR_1}\nevolved into {STR_VAR_2}!{WAIT_SE}\p");
#elif EVOLUTION_TYPE == DW3_EVOLUTIONS
const u8 gText_CongratsPkmnEvolved[] = _("{STR_VAR_2} digievolution learned!{WAIT_SE}\p");
#endif
