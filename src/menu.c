...
static void UNUSED DrawMonIconAtPos(u8 windowId, u16 speciesId, u8 form, u8 gender, u16 x, u16 y)
{
    BlitBitmapToWindow(windowId, GetMonIconPtr(speciesId, form, gender), x, y, 32, 32);
}
